...
const generateAPISpecs = code(({ json }) => {
    ...
    const apis = Object.entries(paths)
        ...
        return Object.keys(value)
            ...
            const operationId = value[method].operationId ||
            ...
            const parameters = "parameters" in data == false
                ? []
            ...
            const requestBody = "requestBody" in data == false
                ? undefined
            ...
            if ("components" in json && "securitySchemes" in json.components) {
                ...
                const bearerSecurity = Object.entries(json.components.securitySchemes).find(([securityMethodKey, securityValue]) => {
...
const createSpecBoard = board((apiSpec) => {
                    ...
                    schema: {
                        ...
                        properties: {
                            requestBody: {
                                type: "object",
                                title: "requestBody",
                                description: item.requestBody["application/json"].description ||
    ...
    const graphInputs = apiSpec.item.to(createBoardInputs({
