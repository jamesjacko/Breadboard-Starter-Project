...
const it = (e) => we.sanitizeText(e, L1), P1 = function(e) {
  ...
  F !== void 0 && F.trim().length !== 0 && (D[F] === void 0 && (D[F] = {
    ...
    styles: [],
    classes: []
  }), Xt++, u !== void 0 ? (L1 = et(), U = it(u.text.trim()), D[F].labelType = u.type, U[0] === '"' && U[U.length - 1] === '"' && (U = U.substring(1, U.length - 1)), D[F].text = U) : D[F].text === void 0 && (D[F].text = e), i !== void 0 && (D[F].type = i), n?.forEach(function(w) {
    D[F].styles.push(w);
  ...
  const h = i.text;
  if (h !== void 0 && (l.text = it(h.text.trim()), l.text[0] === '"' && l.text[l.text.length - 1] === '"' && (l.text = l.text.substring(1, l.text.length - 1)), l.labelType = h.type), i !== void 0 && (l.type = i.type, l.stroke = i.stroke, l.length = i.length), l?.length > 10 && (l.length = 10), H.length < (L1.maxEdges ?? 500))
...
You have to call mermaid.initialize.`
  ...
  e.split(",").forEach(function(i) {
    V1[i] === void 0 && (V1[i] = { id: i, styles: [], textStyles: [] }), u?.forEach(function(n) {
      if (n.match("color")) {
