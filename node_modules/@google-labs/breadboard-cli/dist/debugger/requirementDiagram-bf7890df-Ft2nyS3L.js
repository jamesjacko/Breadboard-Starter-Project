import { c as Te, s as Ce, g as Fe, b as Me, a as De, l as Ne, D as Pe, h as oe, i as Ye, j as ke } from "./mermaid.core-zryH3lCi.js";
import { G as Ue } from "./graph-7cJiVwLj.js";
import { l as Be } from "./layout-skgXVq3z.js";
import { l as Qe } from "./line-JcsobqJS.js";
...
var ce = function() {
  var e = function(V, i, n, a) {
    ...
    parse: function(i) {
      var n = this, a = [0], r = [], f = [null], s = [], W = this.table, _ = "", Z = 0, me = 0, Ve = 2, Ie = 1, qe = s.slice.call(arguments, 1), E = Object.create(this.lexer), L = { yy: {} };
...
` + n + "^";
      ...
      test_match: function(i, n) {
        ...
        }, this.options.ranges && (f.yylloc.range = this.yylloc.range.slice(0))), r = i[0].match(/(?:\r\n?|\n).*/g), r && (this.yylineno += r.length), this.yylloc = {
      ...
      next: function() {
        ...
        for (var f = this._currentRules(), s = 0; s < f.length; s++)
          if (a = this._input.match(this.rules[f[s]]), a && (!n || a[0].length > n[0].length)) {
        ...
        return n ? (i = this.test_match(n, f[r]), i !== !1 ? i : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
