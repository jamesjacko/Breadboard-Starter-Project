import { c as rt, g as mt, s as _t, a as kt, b as xt, C as vt, B as bt, D as wt, j as St, am as Lt, h as G, r as Et } from "./mermaid.core-zryH3lCi.js";
import { o as At } from "./ordinal-MzvJatBI.js";
import { s as Tt } from "./Tableau10-qYUhSEbv.js";
...
function Wt(t) {
  ...
  function g() {
    ...
    if (k || (k = p = gt()), t(k, +a.apply(this, (i[0] = o, i)), +u.apply(this, i), +a.apply(this, (i[0] = c, i)), +u.apply(this, i)), p)
...
const se = {
  ...
  let p;
  u === "sandbox" && (p = G("#i" + n));
  const i = u === "sandbox" ? G(p.nodes()[0].contentDocument.body) : G("body"), o = u === "sandbox" ? i.select(`[id="${n}"]`) : G(`[id="${n}"]`), c = k?.width ?? g.width, m = k?.height ?? g.width, b = k?.useMaxWidth ?? g.useMaxWidth, y = k?.nodeAlignment ?? g.nodeAlignment, x = k?.prefix ?? g.prefix, E = k?.suffix ?? g.suffix, L = k?.showValues ?? g.showValues, A = a.db.getGraph(), N = se[y];
...
${x}${Math.round(w * 100) / 100}${E}` : d;
  ...
  const O = o.append("g").attr("class", "links").attr("fill", "none").attr("stroke-opacity", 0.5).selectAll(".link").data(A.links).join("g").attr("class", "link").style("mix-blend-mode", "multiply"), C = k?.linkColor || "gradient";
  if (C === "gradient") {
