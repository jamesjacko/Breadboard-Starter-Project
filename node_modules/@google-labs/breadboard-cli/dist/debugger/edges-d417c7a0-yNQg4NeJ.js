import { p as H, c as b, d as q, b2 as Q, h as E, l as g, z as j, E as lt } from "./mermaid.core-zryH3lCi.js";
import { a as st } from "./createText-423428c9-OIZHiVYJ.js";
import { l as ct } from "./line-JcsobqJS.js";
const ht = (e, t, a, i) => {
  t.forEach((l) => {
    wt[l](e, a, i);
  });
...
const or = async (e, t, a) => {
  ...
  var t, a;
  const i = ((t = e?.subGraphTitleMargin) == null ? void 0 : t.top) ?? 0, l = ((a = e?.subGraphTitleMargin) == null ? void 0 : a.bottom) ?? 0, r = i + l;
  return {
...
const gr = (e, t) => {
  ...
  const o = r.node(t.v);
  var h = r.node(t.w);
  h?.intersect && o?.intersect && (n = n.slice(1, a.points.length - 1), n.unshift(o.intersect(n[0])), n.push(h.intersect(n[n.length - 1]))), a.toCluster && (g.debug("to cluster abc88", i[a.toCluster]), n = et(a.points, i[a.toCluster].node), c = !0), a.fromCluster && (g.debug("from cluster abc88", i[a.fromCluster]), n = et(n.reverse(), i[a.fromCluster].node).reverse(), c = !0);
