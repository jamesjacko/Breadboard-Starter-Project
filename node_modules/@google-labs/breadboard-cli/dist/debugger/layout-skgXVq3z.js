import { a as F, b as xn, c as zn, d as L, k as Un, e as Hn, g as jn, j as P, l as En, m as kn, n as yn, t as Jn, o as Nn, p as Kn, q as Zn, f as s, G as x, h as w, i as g, r as M, v as y, s as Y } from "./graph-7cJiVwLj.js";
import { a3 as A, a4 as Qn, a5 as ne, a6 as ee, a7 as Ln, a8 as B, a9 as _n, aa as re, ab as Cn, ac as J, ad as te, ae as ie, af as K, ag as ae, ah as In, ai as oe, aj as ue, ak as H } from "./mermaid.core-zryH3lCi.js";
var de = /\s/;
function fe(n) {
...
var un = NaN, he = /^[-+]0x[0-9a-f]+$/i, le = /^0b[01]+$/i, ve = /^0o[0-7]+$/i, pe = parseInt;
function we(n) {
  if (typeof n == "number")
    return n;
  if (F(n))
...
function Ie(n, e, r) {
  ...
  if (!t)
    return -1;
  var i = r == null ? 0 : be(r);
  return i < 0 && (i = Ce(t + i, 0)), Hn(n, L(e), i);
}
var Z = _e(Ie);
function Tn(n, e) {
...
function E(n) {
  return n && n.length ? Q(n, K, Me) : void 0;
}
function R(n) {
...
function Be(n, e, r) {
  ...
  return Se(i, function(o, a) {
    return Ae(o, a, r);
  });
}
function Ge(n, e) {
  return Pe(n, e, function(r, t) {
    return Kn(n, t);
  });
}
var V = ge(function(n, e) {
  return n == null ? {} : Ge(n, e);
}), Ve = Math.ceil, Ye = Math.max;
function $e(n, e, r, t) {
  for (var i = -1, o = Ye(Ve((e - n) / (r || 1)), 0), a = Array(o); o--; )
    a[t ? o : ++i] = n, n += r;
  return a;
}
function De(n) {
  return function(e, r, t) {
    return t && typeof t != "number" && B(e, r, t) && (r = t = void 0), e = S(e), r === void 0 ? (r = e, e = 0) : r = S(r), t = t === void 0 ? e < r ? 1 : -1 : S(t), $e(e, r, t, n);
  };
}
var N = De(), O = Ln(function(n, e) {
  if (n == null)
    return [];
  var r = e.length;
  return r > 1 && B(n, e[0], e[1]) ? e = [] : r > 2 && B(e[0], e[1], e[2]) && (e = [e[0]]), Be(n, xn(e, 1), []);
}), qe = 0;
function en(n) {
  var e = ++qe;
  return Zn(n) + e;
...
class ze {
  ...
  toString() {
    for (var e = [], r = this._sentinel, t = r._prev; t !== r; )
      e.push(JSON.stringify(t, Ue)), t = t._prev;
    return "[" + e.join(", ") + "]";
  }
}
function sn(n) {
...
function je(n, e) {
  if (n.nodeCount() <= 1)
    return [];
  var r = Ke(n, e || He), t = Je(r.graph, r.buckets, r.zeroIdx);
  return _(
    m(t, function(i) {
...
function Ze(n) {
  var e = n.graph().acyclicer === "greedy" ? je(n, r(n)) : Qe(n);
  s(e, function(t) {
    var i = n.edge(t);
...
function fr(n) {
  var e = n.graph().rankdir.toLowerCase();
  (e === "bt" || e === "rl") && sr(n), (e === "lr" || e === "rl") && (cr(n), Sn(n));
}
function Sn(n) {
...
function Fn(n) {
  ...
  e.setNode(r, {});
  for (var i, o; pr(e, n) < t; )
    i = wr(e, n), o = e.hasNode(i.v) ? T(n, i) : -T(n, i), mr(e, n, o);
  return e;
}
function pr(n, e) {
  function r(t) {
...
function Dn(n, e, r, t) {
  var i = r.v, o = r.w;
  n.removeEdge(i, o), n.setEdge(t.v, t.w, {}), an(n), tn(n, e), kr(n, e);
}
function kr(n, e) {
...
function Cr(n) {
  var e = C(n, "root", {}, "_root"), r = Ir(n), t = E(y(r)) - 1, i = 2 * t + 1;
...
function Or(n, e, r) {
  var t = Pr(n), i = new x({ compound: !0 }).setGraph({ root: t }).setDefaultNodeLabel(function(o) {
    return n.node(o);
  });
...
function Vr(n) {
  ...
  function r(o) {
    return function(a) {
      a.merged || (g(a.barycenter) || g(o.barycenter) || a.barycenter >= o.barycenter) && Yr(o, a);
    };
  }
  function t(o) {
    return function(a) {
...
function $r(n, e) {
  var r = ir(n, function(c) {
    return w(c, "barycenter");
  }), t = r.lhs, i = O(r.rhs, function(c) {
    return -c.i;
  }), o = [], a = 0, u = 0, d = 0;
  t.sort(Dr(!!e)), d = mn(o, i, d), s(t, function(c) {
...
function Xr(n) {
  var e = Pn(n), r = bn(n, N(1, e + 1), "inEdges"), t = bn(n, N(e - 1, -1, -1), "outEdges"), i = Ar(n);
  gn(n, i);
  for (var o = Number.POSITIVE_INFINITY, a, u = 0, d = 0; d < 4; ++u, ++d) {
    zr(u % 2 ? r : t, u % 4 >= 2), i = D(n);
    var f = Sr(n, i);
    f < o && (d = 0, a = ke(i), o = f);
  }
  gn(n, a);
...
function Ur(n) {
  ...
  s(n.graph().dummyChains, function(r) {
    for (var t = n.node(r), i = t.edgeObj, o = Hr(n, e, i.v, i.w), a = o.path, u = o.lca, d = 0, f = a[d], c = !0; r !== i.w; ) {
      if (t = n.node(r), c) {
...
function Jr(n, e) {
  ...
  function t(i, o) {
    ...
    return s(o, function(c, h) {
      var l = Zr(n, c), v = l ? n.node(l).order : d;
...
function et(n, e, r, t, i) {
  var o = {}, a = rt(n, e, r, i), u = i ? "borderLeft" : "borderRight";
  function d(h, l) {
...
function rt(n, e, r, t) {
  var i = new x(), o = n.graph(), a = ut(o.nodesep, o.edgesep, t);
  return s(e, function(u) {
    var d;
    s(u, function(f) {
      var c = r[f];
...
function ot(n) {
  var e = D(n), r = H(Jr(n, e), Kr(n, e)), t = {}, i;
  s(["u", "d"], function(a) {
    i = a === "u" ? e : y(e).reverse(), s(["l", "r"], function(u) {
      u === "r" && (i = m(i, function(h) {
        return y(h).reverse();
      }));
      var d = (a === "u" ? n.predecessors : n.successors).bind(n), f = nt(n, i, r, d), c = et(n, i, f.root, f.align, u === "r");
      u === "r" && (c = $(c, function(h) {
        return -h;
      })), t[a + u] = c;
    });
  ...
  var o = tt(n, t);
  return it(t, o), at(t, n.graph().align);
}
function ut(n, e, r) {
...
function ft(n) {
  n = On(n), st(n), Te(ot(n), function(e, r) {
    n.node(r).x = e;
  });
}
function st(n) {
...
var lt = ["nodesep", "edgesep", "ranksep", "marginx", "marginy"], vt = { ranksep: 50, edgesep: 20, nodesep: 50, rankdir: "tb" }, pt = ["acyclicer", "ranker", "rankdir", "align"], wt = ["width", "height"], mt = { width: 0, height: 0 }, bt = ["minlen", "weight", "width", "height", "labeloffset"], gt = {
  minlen: 1,
  weight: 1,
  width: 0,
  height: 0,
...
function Et(n) {
  ...
  return e.setGraph(
    ...
    var i = U(n.node(t));
    e.setNode(t, Le(z(i, wt), mt)), e.setParent(t, n.parent(t));
