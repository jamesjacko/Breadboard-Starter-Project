import { c as _e, X as se, h as H, i as ye, l as S, D as Ee, A as we, o as De } from "./mermaid.core-zryH3lCi.js";
import { c as ve } from "./clone-d2Mcmy9y.js";
import { i as Ne, c as ke, b as Ie, d as Oe, a as he, p as Te } from "./edges-d417c7a0-yNQg4NeJ.js";
import { G as ze } from "./graph-7cJiVwLj.js";
import { o as Ce } from "./ordinal-MzvJatBI.js";
import { c as Ae } from "./channel-3_D9O4Ou.js";
import { s as Re } from "./Tableau10-qYUhSEbv.js";
import "./config-QQQDC_TM.js";
import "./createText-423428c9-OIZHiVYJ.js";
import "./line-JcsobqJS.js";
import "./array-R1yjboNr.js";
import "./path-MiygxnzY.js";
import "./init-KZwjbhwi.js";
var oe, le, ee = function() {
  var e = function(D, l, s, i) {
    for (s = s || {}, i = D.length; i--; s[D[i]] = l)
      ;
    return s;
  }, a = [1, 7], d = [1, 13], c = [1, 14], n = [1, 15], g = [1, 19], o = [1, 16], f = [1, 17], b = [1, 18], p = [8, 30], x = [8, 21, 28, 29, 30, 31, 32, 40, 44, 47], y = [1, 23], T = [1, 24], v = [8, 15, 16, 21, 28, 29, 30, 31, 32, 40, 44, 47], N = [8, 15, 16, 21, 27, 28, 29, 30, 31, 32, 40, 44, 47], E = [1, 49], L = {
    trace: function() {
    },
    yy: {},
    ...
    performAction: function(l, s, i, u, h, t, m) {
      var r = t.length - 1;
      switch (h) {
        case 4:
        ...
        case 13:
          ...
          break;
        case 14:
          u.getLogger().debug("Rule: link: ", t[r], l), this.$ = { edgeTypeStr: t[r], label: "" };
          break;
        case 15:
    ...
    table: [{ 9: 1, 10: [1, 2] }, { 1: [3] }, { 11: 3, 13: 4, 19: 5, 20: 6, 21: a, 22: 8, 23: 9, 24: 10, 25: 11, 26: 12, 28: d, 29: c, 31: n, 32: g, 40: o, 44: f, 47: b }, { 8: [1, 20] }, e(p, [2, 12], { 13: 4, 19: 5, 20: 6, 22: 8, 23: 9, 24: 10, 25: 11, 26: 12, 11: 21, 21: a, 28: d, 29: c, 31: n, 32: g, 40: o, 44: f, 47: b }), e(x, [2, 16], { 14: 22, 15: y, 16: T }), e(x, [2, 17]), e(x, [2, 18]), e(x, [2, 19]), e(x, [2, 20]), e(x, [2, 21]), e(x, [2, 22]), e(v, [2, 25], { 27: [1, 25] }), e(x, [2, 26]), { 19: 26, 26: 12, 32: g }, { 11: 27, 13: 4, 19: 5, 20: 6, 21: a, 22: 8, 23: 9, 24: 10, 25: 11, 26: 12, 28: d, 29: c, 31: n, 32: g, 40: o, 44: f, 47: b }, { 41: [1, 28], 43: [1, 29] }, { 45: [1, 30] }, { 48: [1, 31] }, e(N, [2, 29], { 33: 32, 36: [1, 33], 38: [1, 34] }), { 1: [2, 7] }, e(p, [2, 13]), { 26: 35, 32: g }, { 32: [2, 14] }, { 17: [1, 36] }, e(v, [2, 24]), { 11: 37, 13: 4, 14: 22, 15: y, 16: T, 19: 5, 20: 6, 21: a, 22: 8, 23: 9, 24: 10, 25: 11, 26: 12, 28: d, 29: c, 31: n, 32: g, 40: o, 44: f, 47: b }, { 30: [1, 38] }, { 42: [1, 39] }, { 42: [1, 40] }, { 46: [1, 41] }, { 49: [1, 42] }, e(N, [2, 30]), { 18: [1, 43] }, { 18: [1, 44] }, e(v, [2, 23]), { 18: [1, 45] }, { 30: [1, 46] }, e(x, [2, 28]), e(x, [2, 35]), e(x, [2, 36]), e(x, [2, 37]), e(x, [2, 38]), { 37: [1, 47] }, { 34: 48, 35: E }, { 15: [1, 50] }, e(x, [2, 27]), e(N, [2, 33]), { 39: [1, 51] }, { 34: 52, 35: E, 39: [2, 31] }, { 32: [2, 15] }, e(N, [2, 34]), { 39: [2, 32] }],
    ...
    parse: function(l) {
      ...
      w.setInput(l, K.yy), K.yy.lexer = w, K.yy.parser = this, typeof w.yylloc > "u" && (w.yylloc = {});
      var J = w.yylloc;
      t.push(J);
...
` + s + "^";
      ...
      test_match: function(l, s) {
        ...
        }, this.options.ranges && (h.yylloc.range = this.yylloc.range.slice(0))), u = l[0].match(/(?:\r\n?|\n).*/g), u && (this.yylineno += u.length), this.yylloc = {
          first_line: this.yylloc.last_line,
          last_line: this.yylineno + 1,
          first_column: this.yylloc.last_column,
          last_column: u ? u[u.length - 1].length - u[u.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + l[0].length
        }, this.yytext += l[0], this.match += l[0], this.matches = l, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = !1, this._backtrack = !1, this._input = this._input.slice(l[0].length), this.matched += l[0], i = this.performAction.call(this, this.yy, this, s, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = !1), i)
          return i;
        if (this._backtrack) {
          for (var t in h)
            this[t] = h[t];
      ...
      next: function() {
        ...
        for (var h = this._currentRules(), t = 0; t < h.length; t++)
          if (i = this._input.match(this.rules[h[t]]), i && (!s || i[0].length > s[0].length)) {
            if (s = i, u = t, this.options.backtrack_lexer) {
              if (l = this.test_match(i, h[t]), l !== !1)
                return l;
              if (this._backtrack) {
                s = !1;
                continue;
        ...
        return s ? (l = this.test_match(s, h[u]), l !== !1 ? l : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
...
const Fe = function(e, a = "") {
  ...
  a?.split(ge).forEach((c) => {
    ...
    if (c.match(ce)) {
      const o = n.replace(ue, Pe).replace(ce, ue);
      d.textStyles.push(o);
    }
    d.styles.push(n);
  });
...
function fe(e, a, d = !1) {
  ...
  const o = e;
  let f = "default";
  (((c = o?.classes) == null ? void 0 : c.length) || 0) > 0 && (f = (o?.classes || []).join(" ")), f = f + " flowchart-label";
  let b = 0, p = "", x;
  switch (o.type) {
    case "round":
      b = 5, p = "rect";
  ...
  const y = De(o?.styles || []), T = o.label, v = o.size || { width: 0, height: 0, x: 0, y: 0 };
  return {
...
async function nt(e, a, d) {
  ...
  if (c.type === "group")
    return;
  const n = await he(e, c), g = n.node().getBBox(), o = d.getBlock(c.id);
  o.size = { width: g.width, height: g.height, x: 0, y: 0, node: n }, d.setBlock(o), n.remove();
}
...
async function ct(e, a, d, c, n) {
  ...
  for (const o of a)
    if (o.start && o.end) {
      const f = c.getBlock(o.start), b = c.getBlock(o.end);
      if (f?.size && b?.size) {
...
const _ = ((le = (oe = _e()) == null ? void 0 : oe.block) == null ? void 0 : le.padding) || 8;
function ut(e, a) {
...
const dt = (e) => {
  ...
  for (const c of e.children) {
    const { width: n, height: g, x: o, y: f } = c.size || { width: 0, height: 0, x: 0, y: 0 };
    S.debug(
...
function te(e, a, d = 0, c = 0) {
  ...
  if (((o = e.children) == null ? void 0 : o.length) > 0) {
    ...
    k > 0 && k < D && (l = k), e.widthInColumns;
    const s = Math.ceil(D / l);
    let i = l * (E + _) + _, u = s * (L + _) + _;
    if (i < d) {
      S.debug(
        `Detected to small siebling: abc95 ${e.id} sieblingWidth ${d} sieblingHeight ${c} width ${i}`
      ), i = d, u = c;
      const h = (d - l * _ - _) / l, t = (c - s * _ - _) / s;
      S.debug("Size indata abc88", e.id, "childWidth", h, "maxWidth", E), S.debug("Size indata abc88", e.id, "childHeight", t, "maxHeight", L), S.debug("Size indata abc88 xSize", l, "paddiong", _);
      for (const m of e.children)
        m.size && (m.size.width = h, m.size.height = t, m.size.x = 0, m.size.y = 0);
    }
    if (S.debug(
      `abc95 (finale calc) ${e.id} xSize ${l} ySize ${s} columns ${k}${e.children.length} width=${Math.max(i, ((f = e.size) == null ? void 0 : f.width) || 0)}`
...
function be(e, a) {
  var d, c, n, g, o, f, b, p, x, y, T, v, N, E, L, A, k;
  S.debug(
  ...
  e.children.length > 0) {
    const l = ((o = (g = e?.children[0]) == null ? void 0 : g.size) == null ? void 0 : o.width) || 0, s = e.children.length * l + (e.children.length - 1) * _;
...
function xe(e, { minX: a, minY: d, maxX: c, maxY: n } = { minX: 0, minY: 0, maxX: 0, maxY: 0 }) {
  if (e.size && e.id !== "root") {
    const { x: g, y: o, width: f, height: b } = e.size;
    g - f / 2 < a && (a = g - f / 2), o - b / 2 < d && (d = o - b / 2), g + f / 2 > c && (c = g + f / 2), o + b / 2 > n && (n = o + b / 2);
  }
  if (e.children)
...
function ht(e) {
  ...
  const { minX: d, minY: c, maxX: n, maxY: g } = xe(a), o = g - c, f = n - d;
  return { x: d, y: c, width: f, height: o };
}
const gt = function(e, a) {
  return a.db.getClasses();
}, pt = async function(e, a, d, c) {
  const { securityLevel: n, block: g } = se(), o = c.db;
  let f;
  n === "sandbox" && (f = H("#i" + a));
  ...
  const y = o.getBlocks(), T = o.getBlocksFlat(), v = o.getEdges(), N = p.insert("g").attr("class", "block");
  await ot(N, y, o);
  const E = ht(o);
  if (await lt(N, y, o), await ct(N, v, T, o, a), E) {
    const L = E, A = Math.max(1, Math.round(0.125 * (L.width / L.height))), k = L.height + A + 10, D = L.width + 10, { useMaxWidth: l } = g;
    ye(p, k, D, !!l), S.debug("Here Bounds", E, L), p.attr(
      "viewBox",
