import { p as M, d as _, s as R } from "./styles-6860f46c-gJY_yLbP.js";
import { l as d, c, h as w, z as B, r as G, o as D, q as E, n as C, j as A } from "./mermaid.core-zryH3lCi.js";
import { G as z } from "./graph-7cJiVwLj.js";
import { r as q } from "./index-8fae9850-ArNxLp-f.js";
import "./layout-skgXVq3z.js";
import "./config-QQQDC_TM.js";
import "./clone-d2Mcmy9y.js";
import "./edges-d417c7a0-yNQg4NeJ.js";
...
const P = function(s, t, y, a) {
  ...
  d.info(s), s.forEach(function(e, i) {
    var o, r;
    const l = e, n = "", p = { labelStyle: "", style: "" }, f = l.text, h = 0, m = {
...
`), e.style === void 0 && (o.style = o.style || "stroke: #333; stroke-width: 1.5px;fill:none"), o.labelStyle = o.labelStyle.replace("color:", "fill:"))), t.setEdge(e.id1, e.id2, o, a);
  ...
  d.info("config:", e);
  const o = e?.nodeSpacing ?? 50, r = e?.rankSpacing ?? 50, l = new z({
    multigraph: !0,
    compound: !0
  }).setGraph({
  ...
  let u;
  i === "sandbox" && (u = w("#i" + t));
  const m = i === "sandbox" ? w(u.nodes()[0].contentDocument.body) : w("body"), b = m.select(`[id="${t}"]`), x = m.select("#" + t + " g");
  if (await q(
    x,
    l,
    ...
    "classDiagram",
    t
  ), B.insertTitle(b, "classTitleText", e?.titleTopMargin ?? 5, a.db.getDiagramTitle()), G(l, b, e?.diagramPadding, e?.useMaxWidth), !e?.htmlLabels) {
