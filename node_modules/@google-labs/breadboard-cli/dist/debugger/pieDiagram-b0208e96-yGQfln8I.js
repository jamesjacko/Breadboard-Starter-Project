import { Q as H, T as at, B as lt, C as ot, s as ct, g as ht, b as ut, a as yt, D as ft, d as pt, c as et, l as it, U as gt, P as dt, V as mt, i as _t } from "./mermaid.core-zryH3lCi.js";
import { a as tt } from "./arc-6CVAvqox.js";
import { o as xt } from "./ordinal-MzvJatBI.js";
import { a as kt } from "./array-R1yjboNr.js";
import { c as F } from "./path-MiygxnzY.js";
...
var J = function() {
  var e = function(b, t, i, n) {
    ...
    parse: function(t) {
      var i = this, n = [0], r = [], o = [null], s = [], P = this.table, x = "", f = 0, V = 0, R = 2, M = 1, B = s.slice.call(arguments, 1), h = Object.create(this.lexer), N = { yy: {} };
      ...
      for (var k, L, S, Z, z = {}, j, D, X, W; ; ) {
        if (L = n[n.length - 1], this.defaultActions[L] ? S = this.defaultActions[L] : ((k === null || typeof k > "u") && (k = rt()), S = P[L] && P[L][k]), typeof S > "u" || !S.length || !S[0]) {
          var q = "";
          W = [];
          for (j in P[L])
...
` + h.showPosition() + `
Expecting ` + W.join(", ") + ", got '" + (this.terminals_[k] || k) + "'" : q = "Parse error on line " + (f + 1) + ": Unexpected " + (k == M ? "end of input" : "'" + (this.terminals_[k] || k) + "'"), this.parseError(q, {
            text: h.match,
        ...
        switch (S[0]) {
          case 1:
            n.push(k), o.push(h.yytext), s.push(h.yylloc), n.push(S[1]), k = null, V = h.yyleng, x = h.yytext, f = h.yylineno, Q = h.yylloc;
            break;
          case 2:
