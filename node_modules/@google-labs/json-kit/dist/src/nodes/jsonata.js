...
export const jsonataHandler = async (inputs) => {
    const { expression, raw, ...rest } = inputs;
    if (!expression)
...
export const computeOutputSchema = async (inputs) => {
...
export const jsonataDescriber = async (inputs) => {
