...
declare const safetySetting: SafetySetting;
/**
 ...
 */
export interface PartialGenerateTextRequest extends Omit<GenerateTextRequest, "prompt"> {
    prompt?: TextPrompt;
}
/**
 ...
 * ```
 */
export declare class Text implements GenerateTextRequest {
     ...
     * @returns The builder instance.
     */
    addSafetySetting(category: SafetyCategory, threshold: SafetyThreshold): this;
    /**
